...
pub fn default_curriculum_tracks() -> Vec<crate::config::TrackConfig> {
    vec![
        ...
        crate::config::TrackConfig {
            ...
            runner: "node".to_string(),
            exercise_dir: "exercises/06_genai_qa".to_string(),
            extension: ".ts".to_string(),
            command: "npx playwright test {file} --reporter=json".to_string(),
        },
        crate::config::TrackConfig {
            ...
            runner: "python".to_string(),
            exercise_dir: "exercises/07_cloud_devsecops".to_string(),
            extension: ".py".to_string(),
            command: "python -m pytest {file} --json-report --json-report-file=report.json"
                .to_string(),
        },
        ...
        crate::config::TrackConfig {
            ...
            runner: "python".to_string(),
            exercise_dir: "exercises/08_tool_decisions".to_string(),
            extension: ".py".to_string(),
            command: "python -m pytest {file} --json-report --json-report-file=report.json"
                .to_string(),
        },
        crate::config::TrackConfig {
            ...
            runner: "python".to_string(),
            exercise_dir: "exercises/09_contract_pact".to_string(),
            extension: ".py".to_string(),
            command: "python -m pytest {file} --json-report --json-report-file=report.json"
                .to_string(),
        },
        crate::config::TrackConfig {
            ...
            runner: "node".to_string(),
            exercise_dir: "exercises/10_a11y_axe".to_string(),
            extension: ".ts".to_string(),
            command: "npx playwright test {file} --reporter=json".to_string(),
        },
    ]
