...
|---|:---:|:---:|---|
| `page.getByRole('button', { name: '...' })` | **100** | Semantic Accessibility | Mirrors real user interaction; resilient to DOM restructuring |
| `page.getByLabel('...')` | **95** | User-Facing Label | Bound to form accessibility semantics |
| `page.getByPlaceholder('...')` | **90** | Input Placeholder | Standard UI input cue |
| `page.getByTestId('...')` | **85** | Explicit Test ID | Dedicated automation hook |
| `page.getByText('...')` | **75** | Text Content | Readable but vulnerable to localization copy changes |
...
## ?? Micro-Crucible Chaos Injection Headers
...
| ??? **QA Architect** | 10,000 XP | 2.0x |
| ?? **SDET Master** | 20,000 XP | 2.0x |
